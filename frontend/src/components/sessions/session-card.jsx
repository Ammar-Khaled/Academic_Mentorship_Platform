...
export function SessionCard({ session, onReschedule, onCancel, showActions = true }) {
  ...
  return (
    <Card>
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will free up the slot and notify your mentor. This action cannot be undone.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
      ...
      {session.description && (
        <CardContent className="pt-0 text-sm text-muted-foreground">{session.description}</CardContent>
      )}
    </Card>
  );
}
